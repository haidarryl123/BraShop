...
<head>
  ...
  <!-- NProgress -->
  <link href="{{url('public/backend')}}/vendors/nprogress/nprogress.css" rel="stylesheet">
  <!-- iCheck -->
  <link href="{{url('public/backend')}}/vendors/iCheck/skins/flat/green.css" rel="stylesheet">
  <!-- bootstrap-wysiwyg -->
  <link href="{{url('public/backend')}}/vendors/google-code-prettify/bin/prettify.min.css" rel="stylesheet">
  <!-- Select2 -->
  <link href="{{url('public/backend')}}/vendors/select2/dist/css/select2.min.css" rel="stylesheet">
  <!-- Switchery -->
  <link href="{{url('public/backend')}}/vendors/switchery/dist/switchery.min.css" rel="stylesheet">
  <!-- starrr -->
  <link href="{{url('public/backend')}}/vendors/starrr/dist/starrr.css" rel="stylesheet">
  <!-- bootstrap-daterangepicker -->
  <link href="{{url('public/backend')}}/vendors/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">

  <!-- Custom Theme Style -->
  @yield('css')
  <link href="{{url('public/backend')}}/build/css/custom.min.css" rel="stylesheet">
</head>
        ...
        <div class="left_col scroll-view">
          ...
          <div class="profile clearfix">
            <div class="profile_pic">
              <img src="{{url('public/backend')}}/images/img.jpg" alt="..." class="img-circle profile_img">
            </div>
...
<!-- Bootstrap -->
<script src="{{url('public/backend')}}/vendors/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
<!-- FastClick -->
...
<script src="{{url('public/backend')}}/vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
<!-- iCheck -->
<script src="{{url('public/backend')}}/vendors/iCheck/icheck.min.js"></script>
<!-- bootstrap-daterangepicker -->
...
<!-- jQuery Tags Input -->
<script src="{{url('public/backend')}}/vendors/jquery.tagsinput/src/jquery.tagsinput.js"></script>
<!-- Switchery -->
<script src="{{url('public/backend')}}/vendors/switchery/dist/switchery.min.js"></script>
<!-- Select2 -->
<script src="{{url('public/backend')}}/vendors/select2/dist/js/select2.full.min.js"></script>
<!-- Parsley -->
<script src="{{url('public/backend')}}/vendors/parsleyjs/dist/parsley.min.js"></script>
<!-- Autosize -->
<script src="{{url('public/backend')}}/vendors/autosize/dist/autosize.min.js"></script>
<!-- jQuery autocomplete -->
<script src="{{url('public/backend')}}/vendors/devbridge-autocomplete/dist/jquery.autocomplete.min.js"></script>
<!-- starrr -->
<script src="{{url('public/backend')}}/vendors/starrr/dist/starrr.js"></script>
