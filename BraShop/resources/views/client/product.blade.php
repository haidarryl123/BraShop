                ...
                <div class="col-lg-6">
                    <div class="product__details__img">
                        <div class="product__details__big__img">
                            ...
                            <img class="big_img" src="{{url('public/frontend/img/product')}}/{{$products->image}}" alt="">
                        </div>
                        <div class="product__details__thumb">
                            <div class="pt__item active">
                                <img data-imgbigurl="{{url('public/frontend/img/product')}}/{{$products->image}}"
                                src="{{url('public/frontend/img/product')}}/{{$products->image}}" alt="">
                            </div>
                            <div class="pt__item">
                                <img data-imgbigurl="{{url('public/frontend/img/product')}}/{{$products->image}}"
                                src="{{url('public/frontend/img/product')}}/{{$products->image}}" alt="">
                    ...
                    @foreach ($relate as $key => $relates)
                        <div class="col-lg-3">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="{{url('public/frontend/img/product')}}/{{$relates->image}}">
