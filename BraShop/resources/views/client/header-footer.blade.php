...
<html lang="zxx">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{url('public/frontend')}}/css/barfiller.css" type="text/css">
    ...
    <body>
        ...
        <div class="offcanvas-menu-wrapper">
            <div class="offcanvas__cart">
                <div class="offcanvas__cart__links">
                    <a href="#" class="search-switch"><img src="{{url('public/frontend')}}/img/icon/search.png" alt=""></a>
                </div>
                <div class="offcanvas__cart__item">
                    <a href="{{route('cart.index')}}"><img src="{{url('public/frontend')}}/img/icon/cart.png" alt=""> <span>{{$cart->total_qtt}}</span></a>
                    <div class="cart__price">Cart: <span>{{number_format($cart->total_price)}} VND</span></div>
                </div>
            </div>
            <div class="offcanvas__logo">
                <a href="{{route('client.index')}}"><img src="{{url('public/frontend')}}/img/logo/logo.png" alt="" width="100px"></a>
            </div>
                            ...
                            <div class="header__top__inner">
                                ...
                                <div class="header__logo">
                                    <a href="{{route('client.index')}}">
                                        <img src="{{url('public/frontend')}}/img/logo/logo.png" alt="" width="160px" height="70px">
                                    </a>
                                </div>
        ...
        <footer class="footer set-bg" data-setbg="{{url('public/frontend')}}/img/footer-bg.jpg">
            <div class="container">
                <div class="row">
        ...
        <script src="{{url('public/frontend')}}/js/jquery.barfiller.js"></script>
        ...
        <script src="{{url('public/frontend')}}/js/jquery.nicescroll.min.js"></script>
